<template>
  <div class="fixed inset-0 z-50 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
    <div class="flex items-center justify-center min-h-screen p-0 sm:p-4 text-center">
      <div class="fixed inset-0 bg-gray-900 bg-opacity-75 transition-opacity" aria-hidden="true" @click="$emit('close')"></div>

      <div class="relative w-full h-full sm:h-auto sm:max-h-[90vh] sm:max-w-3xl bg-gray-800 sm:rounded-lg text-left overflow-hidden shadow-xl transform transition-all border-0 sm:border sm:border-gray-700 flex flex-col">
