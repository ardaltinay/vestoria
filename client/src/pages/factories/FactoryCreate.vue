<template>
  <div class="p-6 max-w-xl">
    <h1 class="text-2xl font-bold mb-4">Yeni Fabrika Aç</h1>
    <form @submit.prevent="submit" class="bg-white rounded-lg p-4 shadow">
      <label class="block mb-3">
        <div class="text-sm text-gray-600 mb-1">Fabrika İsmi</div>
      ...
      <div class="flex items-center gap-2 mt-4">
        ...
        <RouterLink to="/home/factories" class="px-4 py-2 bg-gray-200 text-gray-800 rounded text-sm">İptal</RouterLink>
      </div>
    </form>
  </div>
</template>
