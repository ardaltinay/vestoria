    ...
    <div v-else class="space-y-6">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
        ...
        <div class="bg-gradient-to-br from-orange-50 to-orange-100 rounded-xl p-4 sm:p-5 border border-orange-200">
          <div class="flex items-center justify-between">
            <div>
              <div class="text-xs sm:text-sm font-medium text-orange-600 mb-1">Stok Durumu</div>
              <div class="text-2xl sm:text-3xl font-bold" :class="{'text-red-600': !currentStock, 'text-orange-900': currentStock > 0}">
                {{ currentStock }}<span class="text-base sm:text-lg text-orange-700 font-normal">/{{ item.maxStock }}</span>
              </div>
            </div>
        ...
        <div class="bg-white rounded-2xl w-full max-w-md overflow-hidden shadow-2xl relative">
          ...
          <div class="p-6 space-y-4">
            ...
            <p class="text-slate-600 text-sm">
              Madeninizde üretim başlatmak üzeresiniz. Üretim {{ buildingConfig?.productionDuration || '-' }} dakika sürecektir.
            </p>
