          ...
          <div class="flex items-start justify-between">
            <div class="flex items-center gap-3 flex-1">
              ...
              <div class="flex-1 min-w-0">
                <h3 class="font-bold text-gray-900 group-hover:text-yellow-600 transition-colors text-sm sm:text-base truncate">{{ it.subType }}</h3>
                <span class="inline-block mt-1 text-xs font-semibold text-yellow-700 bg-yellow-100 px-2 py-0.5 rounded-full">
                  Seviye {{ it.level }}
                </span>
              </div>
            </div>
        ...
        <div class="p-4 sm:p-5 space-y-4">
          ...
          <div class="grid grid-cols-2 gap-2 sm:gap-3">
            <div class="bg-gray-50 rounded-lg p-2.5 sm:p-3 border border-gray-200">
              ...
              <div class="text-base sm:text-lg font-bold text-gray-900">₺{{ it.productionRate || 0 }}</div>
            </div>
            <div class="bg-gray-50 rounded-lg p-2.5 sm:p-3 border border-gray-200">
          ...
          <div>
            <div class="flex justify-between text-xs mb-1.5">
              <span class="text-gray-500 font-medium">Hasat</span>
