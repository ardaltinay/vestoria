<template>
  <div class="p-6">
    <div class="flex items-center justify-between mb-6">
      ...
      <div>
        <RouterLink to="/home/gardens" class="px-3 py-1 text-sm text-gray-600 hover:text-brand-yellow">Geri</RouterLink>
      </div>
    </div>
    ...
    <div v-else>
      ...
      <div v-if="!item.subType" class="bg-white rounded-lg p-6 shadow mb-6 border-l-4 border-indigo-500">
        ...
        <p class="text-gray-600 mb-4">Bu bahçe henüz üretim yapmıyor. Üretime başlamak için bir tür seçin:</p>
...
async function fetchProductionTypes() {
  try {
    ...
    productionOptions.value = response.data.filter(t => t.parentType === 'GARDEN')
  } catch (error) {
