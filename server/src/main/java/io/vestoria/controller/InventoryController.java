...
public class InventoryController {
    ...
    public ResponseEntity<?> transferToBuilding(@RequestBody Map<String, Object> request, Principal principal) {
        ...
        return ResponseEntity
                .ok(inventoryService.transferToBuilding(itemId, buildingId, quantity, principal.getName()));
    }
}
