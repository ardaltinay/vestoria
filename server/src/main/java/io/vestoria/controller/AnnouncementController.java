...
public class AnnouncementController {
    ...
    @PostMapping("/create")
    public ResponseEntity<?> create(@Valid @RequestBody CreateAnnouncementRequestDto request, Principal principal) {
        ...
        return ResponseEntity.ok(
                announcementService.createAnnouncement(request.getTitle(), request.getContent(), request.getType()));
    }
}
