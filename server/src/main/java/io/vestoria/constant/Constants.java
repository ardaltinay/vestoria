...
public class Constants {
        ...
        public static final List<String> GARDEN_ITEMS = List.of("Zeytin", "Havuç", "Patates", "Domates", "Salatalık",
                        "Biber", "Patlıcan", "Soğan", "Elma", "Armut", "Mandalin", "Portakal", "Çilek", "Kiraz",
                        "Şeftali", "Limon",
                        "Karpuz", "Kavun");

        // Çiftlik Ürünleri
        public static final List<String> FARM_ITEMS = List.of("İnek", "Koyun", "Keçi", "Deri", "Süt", "Yumurta",
                        "Tavuk",
                        "Hindi", "Yün", "Pamuk", "Buğday", "Mısır", "Arpa", "Tütün", "Ayçiçeği", "Kakao");

        // Maden Ürünleri
        public static final List<String> MINE_ITEMS = List.of("Kömür", "Demir", "Bakır", "Altın", "Gümüş", "Petrol",
                        "Taş",
                        "Tuz");
        ...
        // Market Ürünleri
        public static final List<String> MARKET_ITEMS = List.of("Tuz", "Sigara", "Puro", "Ekmek", "Meyve Suyu",
                        "Peynir",
                        "Yoğurt", "Zeytin", "Un", "Sucuk", "Salam", "Sabun", "Çikolata", "Bira", "Çömlek", "Su");

        // Manav Ürünleri
        public static final List<String> GREENGROCER_ITEMS = List.of("Havuç", "Patates", "Domates", "Salatalık",
                        "Biber",
                        "Patlıcan", "Soğan", "Elma", "Armut", "Mandalin", "Portakal", "Çilek", "Kiraz", "Şeftali",
                        "Limon",
                        "Karpuz", "Kavun");
        ...
        public static final Map<String, BigDecimal> BASE_PRICES = Map.ofEntries(
                        ...
                        Map.entry("Su", BigDecimal.valueOf(2)),
                        Map.entry("Ayçiçek Yağı", BigDecimal.valueOf(20)),
                        Map.entry("Meyve Suyu", BigDecimal.valueOf(5)),
                        Map.entry("Peynir", BigDecimal.valueOf(20)), Map.entry("Yoğurt", BigDecimal.valueOf(5)),
                        Map.entry("Sucuk", BigDecimal.valueOf(25)), Map.entry("Salam", BigDecimal.valueOf(20)),
                        Map.entry("Bira", BigDecimal.valueOf(35)), Map.entry("Sigara", BigDecimal.valueOf(40)),
                        Map.entry("Puro", BigDecimal.valueOf(100)), Map.entry("Çikolata", BigDecimal.valueOf(50)),
                        Map.entry("Sabun", BigDecimal.valueOf(15)), Map.entry("Kumaş", BigDecimal.valueOf(40)),
                        Map.entry("Kıyafet", BigDecimal.valueOf(80)), Map.entry("Ceket", BigDecimal.valueOf(150)),
                        Map.entry("Ayakkabı", BigDecimal.valueOf(120)),
                        Map.entry("Demir Levha", BigDecimal.valueOf(50)),
                        Map.entry("Çelik", BigDecimal.valueOf(80)), Map.entry("Demir Çelik", BigDecimal.valueOf(80)),
                        Map.entry("Alet Ekipman", BigDecimal.valueOf(150)),
                        Map.entry("Plastik", BigDecimal.valueOf(10)),
                        Map.entry("Çömlek", BigDecimal.valueOf(20)),
