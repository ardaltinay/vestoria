...
public class Constants {
    ...
    public static final List<String> MARKET_ITEMS = List.of("Tuz", "Sigara", "Puro", "Ekmek", "Meyve Suyu", "Peynir",
            "Yoğurt", "Zeytin", "Un", "Sucuk", "Salam", "Sabun", "Çikolata", "Bira", "Çömlek");
    ...
    public static final Map<String, BigDecimal> BASE_PRICES = Map.ofEntries(
            ...
            Map.entry("Ayçiçek Yağı", BigDecimal.valueOf(20)), Map.entry("Meyve Suyu", BigDecimal.valueOf(5)),
            ...
            Map.entry("Ayakkabı", BigDecimal.valueOf(120)), Map.entry("Demir Levha", BigDecimal.valueOf(50)),
            Map.entry("Çelik", BigDecimal.valueOf(80)), Map.entry("Demir Çelik", BigDecimal.valueOf(80)),
            Map.entry("Alet Ekipman", BigDecimal.valueOf(150)), Map.entry("Plastik", BigDecimal.valueOf(10)),
            Map.entry("Çömlek", BigDecimal.valueOf(20)), Map.entry("Kuyumcu Malzemeleri", BigDecimal.valueOf(200)),
